...
function QuestionnaireProgress({
  ...
  return (
    <QuestionnairePrimitive.Progress
      ...
      className={cn(
        'cn-questionnaire-progress text-muted-foreground min-h-[1lh] w-fit min-w-[14ch] font-medium tabular-nums',
        className,
      )}
      {...props}
    />
...
function QuestionnaireDescription({
  ...
  return (
    <QuestionnairePrimitive.Description
      ...
      className={cn(
        'cn-questionnaire-description text-muted-foreground text-pretty',
        className,
      )}
      {...props}
    />
    ...
    >
      ...
      >
        ...
        <CheckIcon
          ...
          className="cn-questionnaire-choice-indicator-check hidden group-data-checked/questionnaire-choice:block group-data-[type=radio]/questionnaire-choice:hidden"
        />
      </span>
